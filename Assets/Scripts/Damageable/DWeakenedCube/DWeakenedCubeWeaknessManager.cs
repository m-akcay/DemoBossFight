...
public class DWeakenedCubeWeaknessManager : MonoBehaviour
{
    ...
    [SerializeField] private List<DamageableObject.Weakness> _weaknessMapDebug;
    ...
    public void UpdateWeakness(in DamageableObject damageable, in AmmoType ammoType)
    {
    ...
    private void UpdateMapping(Dictionary<AmmoType, float> weaknessMap, in AmmoType ammoType)
    {
        ...
        //debug
        var ammoWeakness = new DamageableObject.Weakness();
        ...
        foreach (var key in keys)
        {
            ...
            var weakness = new DamageableObject.Weakness();
